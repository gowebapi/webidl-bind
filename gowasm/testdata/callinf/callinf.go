...
func (t *Foo1Value) allocateTest2() js.Callback {
...
func (t *Foo2Value) allocateTest3() js.Callback {
	return js.NewCallback(func(args []js.Value) {
		var (
...
func (t *Foo3Value) allocateTest1() js.Callback {
	return js.NewCallback(func(args []js.Value) {
		var (
			_p0 string // javascript: DOMString a
		)
...
func (t *Foo3Value) allocateTest2() js.Callback {
	return js.NewCallback(func(args []js.Value) {
		var (
			_p0 int // javascript: long b
		)
...
func (t *Foo3Value) allocateTest3() js.Callback {
	return js.NewCallback(func(args []js.Value) {
		var (
...
func (t *Foo3Value) allocateTest4() js.Callback {
	return js.NewCallback(func(args []js.Value) {
		var (
